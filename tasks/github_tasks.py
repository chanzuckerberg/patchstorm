...
"""
        ...
        with open(script_filename, 'w') as f:
            f.write(script)
        cmd = f"""docker run -v {repo_dir}:/repo -v {script_filename}:/claude_cmds.sh -e ANTHROPIC_API_KEY --network appnet --workdir /repo --env-file /secrets/.env.custom claude_code bash /claude_cmds.sh"""
